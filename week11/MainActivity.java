...
public class MainActivity extends AppCompatActivity implements NoteFragment.OnNoteListInteractionListener{
    ...
    ListenerRegistration listenerRegistration; //to communicate w database
...
//        });
        ...
        listenerRegistration = db.collection("notes").orderBy("date",
            ...
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                notes.clear();
                for (QueryDocumentSnapshot doc: value){ //herbir not aslında döküman
    ...
    @Override
    public boolean onPrepareOptionsMenu(Menu menu) { // when you update the menu this will be called
